...
mod tests {
    ...
    fn bus_existence(){
        ...
        buz.add_bus("KBB 012A".to_string(), "Mombasa-Nairobi".to_string(), 62,   "Active".to_string());
    ...
    fn add_bus(){
        ...
        buz.add_bus("KCA 452Z".to_string(), "Mombasa-Nairobi".to_string(), 62,  "Booked".to_string());
        buz.add_bus("KDH 789D".to_string(), "Kisumu-Siaya".to_string(), 30,   "Active".to_string());
        buz.add_bus("KBB 012A".to_string(), "Nakuru-Nairobi".to_string(), 20,   "Active".to_string());
